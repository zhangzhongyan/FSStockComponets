...
//        }];
        ...
        NSAttributedString *str5 = [[NSAttributedString alloc] initWithString:[NSString stringWithFormat:@" MA5：%.3f ",self.MA.MA4.floatValue] attributes:@{
            NSForegroundColorAttributeName: [UIColor line4Color],
        }];
        
        NSAttributedString *str6 = [[NSAttributedString alloc] initWithString:[NSString stringWithFormat:@" MA20：%.3f ",self.MA.MA5.floatValue] attributes:@{
            NSForegroundColorAttributeName: [UIColor line5Color],
        }];
        
        NSMutableAttributedString *mStr = [[NSMutableAttributedString alloc] initWithAttributedString:str5];
        [mStr appendAttributedString:str2];
        [mStr appendAttributedString:str6];
...
- (BOOL)timeIsUp{
    return  self.Open.floatValue >= self.PrevModel.Open.floatValue;
}

/**
 * 成交量颜色
 */
- (UIColor *)timeIsUpColor {
    UIColor *color;
    
    if (self.Open.floatValue > self.PrevModel.Open.floatValue) {
        return color = [UIColor upColor];
    } else if (self.Open.floatValue < self.PrevModel.Open.floatValue) {
        return color = [UIColor downColor];
    } else {
        return color = [UIColor flatColor];
    }
